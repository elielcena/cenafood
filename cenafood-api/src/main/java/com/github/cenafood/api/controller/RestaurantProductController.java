...
import com.github.cenafood.api.openapi.controller.RestaurantProductControllerOpenApi;
 ...
 */
@RestController
@RequestMapping(value = "/restaurants/{id}/products", produces = MediaType.APPLICATION_JSON_VALUE)
